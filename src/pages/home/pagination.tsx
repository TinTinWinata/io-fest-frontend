...
export default function Pagination({
  ...
  const getActiveClass = () =>
    'cursor-pointer dark:border-orange-500 dark:text-orange-600 border-blue-500 text-blue-600 border-t-2 pt-4 px-4 inline-flex items-center text-sm font-medium';
