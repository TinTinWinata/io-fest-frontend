  ...
  return (
    <div className="relative min-h-screen w-screen flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="relative z-40 bg-white dark:bg-gray-900 dark:border-gray-700 dark:border py-8 px-4 shadow sm:rounded-lg sm:px-10">
          <form
            ...
            <div>
              ...
              <div className="mt-1">
                <input
                  ...
                  autoComplete="email"
                  required
                  className="dark:bg-transparent appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                />
              </div>
            </div>
