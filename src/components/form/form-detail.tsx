...
export default function FormDetail({
  ...
  const getAnswerClass = (index: number) =>
    `w-full border border-blue-600 dark:border-gray-700 dark:border-opacity-30 border-opacity-20 rounded-md p-3 text-sm tracking-wider my-2 dark:hover:bg-orange-600 hover:bg-blue-600 hover:text-gray-50 transition-all dark:text-gray-200 ${
